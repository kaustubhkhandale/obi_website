...
<head>
    <!--====== Title ======-->
    <title>About Us - Orangebits Software Technologies</title>
    <!--====== Required meta tags ======-->
    <meta charset="utf-8" />
...
<body>
    ...
    <section class="infetech-promo-banner-area infetech-promo-banner-about animated wow fadeIn"
    ...
    <section class="infetech-team-area">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-tema-item animated wow fadeInUp" data-wow-duration="1500ms"
