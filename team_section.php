         ...
         <div class="row">
             <div class="col-lg-4 col-md-6 mb-3">
                 <div class="single-tema-item animated wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="0ms">
                     ...
                     <div class="content">
                         <h4 class="title">Rajesh Watkar</h4>
             ...
             <div class="col-lg-4 col-md-6 mb-3">
                 <div class="single-tema-item animated wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                     ...
                     <div class="content">
                         <h4 class="title">Parag Deote</h4>
                         <span>Founder and COO</span>
                         <div class="share-icon">
                             <i class="fas fa-share-alt"></i>
                             <ul>
                                 <li>
             ...
             <div class="col-lg-4 col-md-6 mb-3">
                 <div class="single-tema-item animated wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                     ...
                     <div class="content">
                         <h4 class="title">Sachin Mahajan</h4>
             ...
             <div class="col-lg-4 col-md-6 mb-3">
                 <div class="single-tema-item animated wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                     ...
                     <div class="content">
                         <h4 class="title">Parag Thakur</h4>
             ...
             <div class="col-lg-4 col-md-6 mb-3">
                 <div class="single-tema-item animated wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                     ...
                     <div class="content">
                         <h4 class="title">Ruchi Jain</h4>
                         <span>Associate Director HR</span>
                         <div class="share-icon">
                             <i class="fas fa-share-alt"></i>
                             <ul>
                                 <li>
